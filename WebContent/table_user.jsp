        ...
        <div class="container">
            ...
            <div class="table-body">
                <ul class="nav navbar-nav" style="width: auto;">
                    <li class="active "><a class="create-tb" href="table_welcom.jsp">Bảng chào mừng</a></li>
            ...
            <div style="height: 45px;margin-top:80px;">
                ...
                <a class="table-user" href="card_user.jsp"><span class="glyphicon glyphicon-equalizer">&nbsp;</span>Bảng</a>
                <a class="table-user " href="card_user.jsp"><span class="glyphicon glyphicon-user">&nbsp;</span>Thành viên</a>
